...
\begin{itemize}
    ...
    \item \emph{Operazioni onerose}: per ciascun risultato vengono eseguite diverse operazioni onerose, riportate nel \cref{lst:route-inefficiencies}, molte delle quali si rivelano inutili a causa del successivo filtraggio dei duplicati.
