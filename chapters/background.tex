...
La Figura~\ref{fig:legacy-architecture} illustra schematicamente l'architettura delle tre componenti; di seguito ciascuna di esse viene descritta in dettaglio.
...
\begin{itemize}
    ...
    \item \emph{Ordinamento ridondante}: il risultato ottenuto viene nuovamente ordinato, nonostante fosse stato già eseguito dal componente di upstream.
\end{itemize}
...
Complessivamente, il flusso di una richiesta attraversa le tre componenti descritte secondo la seguente sequenza (\Cref{fig:information-flow}):
