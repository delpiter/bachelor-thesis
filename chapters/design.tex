...
Sfruttando tale pattern, l'esecuzione del fan-out viene eseguito secondo il paradigma di programmazione parallela \emph{master-worker} come in figura \cref{fig:master-worker}, in cui un'unità coordinatrice (\emph{master}) distribuisce i task alle unità esecutrici (\emph{worker}), garantendo così il rispetto del vincolo di parallelismo imposto.
\begin{figure}
    \centering
