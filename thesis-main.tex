...
basato su architettura PHP/Apache eridurre il tempo necessario per la preparazione manuale dei dati di test, automatizzando la fase di setup dell'ambiente. script di fan-out Python, soffriva di limitazioni 
